	...
	local isExistNord, onenord = pcall(require, "onenord")
		if isExistNord then
			onenord.setup {
				...
				DiagnosticVirtualTextError = { fg = _M.colors.magenta },
				DiagnosticVirtualTextWarn = { fg = _M.colors.magenta },
				DiagnosticVirtualTextInfo = { fg = _M.colors.magenta },
				DiagnosticVirtualTextHint = { fg = _M.colors.magenta },
			},
		}
	end
end
